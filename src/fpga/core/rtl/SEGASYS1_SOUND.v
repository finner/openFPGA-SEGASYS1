...
// Full 32KB sound ROM ($0000-$7FFF). System 2 needs this for code + SNDCTL
// (vram_bank via SNDCTL[2:1]). Fits Pocket with sprites still on-chip 32KB.
wire scpu_dl = ROMEN & `EN_SCPU;
DLROM #(15,8) subir( clk40M, cpu_ad[14:0], rom_dt, ROMCL,ROMAD,ROMDT, scpu_dl );
